...
sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"首页",sLast:"上一页",sNext:"下一页",sPrevious:"返回"},sEmptyTable:"无记录",sInfo:"显示 _START_ 至 _END_ 一共 _TOTAL_ 条",sInfoEmpty:"显示 0 至 0 一共 0 条",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"显示 _MENU_ 条",sLoadingRecords:"Loading...",sProcessing:"加载中...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},
